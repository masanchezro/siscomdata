...
{
    public partial class Thcoinmovswm
    {
        public Thcoinmovswm()
        {
            Tdcoinmovscodserieswms = new HashSet<Tdcoinmovscodserieswm>();
            Tdcoinmovscodwms = new HashSet<Tdcoinmovscodwm>();
        }
        ...
        public string Transmitir { get; set; }
        public string Usuario { get; set; }
        public DateTime FechaAudit { get; set; }

        public virtual ICollection<Tdcoinmovscodserieswm> Tdcoinmovscodserieswms { get; set; }
        public virtual ICollection<Tdcoinmovscodwm> Tdcoinmovscodwms { get; set; }
    }
}
