...
{
    public partial class Tmcocamov
    {
        ...
        public virtual Tccocastatusseg IdEstatusSeguimientoNavigation { get; set; }
        public virtual Tdcogrproch Tdcogrproch { get; set; }
        public virtual Tccogriva TipoIvaNavigation { get; set; }
        public virtual Tccogrtmov TipoMovimientoNavigation { get; set; }
