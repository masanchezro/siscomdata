...
{
    public partial class Tccocacuentagasto
    {
        public Tccocacuentagasto()
        {
            Tmcocatrangastos = new HashSet<Tmcocatrangasto>();
        }
        ...
        public virtual Tccocatgasto Tccocatgasto { get; set; }
        public virtual ICollection<Tmcocatrangasto> Tmcocatrangastos { get; set; }
    }
}
