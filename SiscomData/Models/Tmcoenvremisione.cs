...
{
    public partial class Tmcoenvremisione
    {
        ...
        public virtual Tccoenvstatusrem StatusNavigation { get; set; }
        public virtual Tdcoenremisionesnodo Tdcoenremisionesnodo { get; set; }
        public virtual Tccoenvtiporem TipoNavigation { get; set; }
    }
}
